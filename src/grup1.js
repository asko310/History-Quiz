...
function replaceInputWithText(inputId, submitButtonId, text) {
  ...
  document.getElementById('submit1').addEventListener('click', () => submitAnswerToFirestore('input1', 'submit1', 'otherAnswers'));
  document.getElementById('submit2').addEventListener('click', () => submitAnswerToFirestore('input2', 'submit2', 'otherAnswers'));
  document.getElementById('submit3').addEventListener('click', () => submitAnswerToFirestore('input3', 'submit3', 'otherAnswers'));
  document.getElementById('submit4').addEventListener('click', () => submitAnswerToFirestore('input4', 'submit4', 'otherAnswers'));
  document.getElementById('submit5').addEventListener('click', () => submitAnswerToFirestore('input5', 'submit5', 'otherAnswers'));
