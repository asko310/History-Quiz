...
function replaceInputWithText(inputId, submitButtonId, text) {
  ...
  document.getElementById('submit11').addEventListener('click', () => submitAnswerToFirestore('input11', 'submit11', 'otherAnswers'));
  document.getElementById('submit12').addEventListener('click', () => submitAnswerToFirestore('input12', 'submit12', 'otherAnswers'));
  document.getElementById('submit13').addEventListener('click', () => submitAnswerToFirestore('input13', 'submit13', 'otherAnswers'));
  document.getElementById('submit14').addEventListener('click', () => submitAnswerToFirestore('input14', 'submit14', 'otherAnswers'));
  document.getElementById('submit15').addEventListener('click', () => submitAnswerToFirestore('input15', 'submit15', 'otherAnswers'));
